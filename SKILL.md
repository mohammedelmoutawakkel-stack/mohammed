...
description: |
  ...
  closers, spelled-out morals, staged openers, forced triads, dashes everywhere, inflated
  claims, stock body sensations, sales language, stock AI words, bold labels, or filler. Based on Wikipedia's "Signs of AI writing."
license: MIT
metadata:
  version: "3.1.0"
---
...
The same evenness shows at the scale of a whole document. A 2026 study scored 61,608 stories on how they were built rather than how they were worded, and structure alone separated model writing from human writing about nine times in ten: the models resembled each other, and the people did not. So read the shape of the whole text as well as the sentences.

Two rules follow from this. Every sentence you keep must add something the reader did not already have. A tell counts in proportion to how rarely a careful writer would make it on purpose. The patterns are numbered strongest first: §1 to §6 justify an edit on one sighting, and a pattern marked *weak alone* needs company from other tells in the same passage before you act.
...
### 3. Explaining what the example already showed

**Watch for:** a sentence after an example, scene, or number that names its meaning ("It was a lesson in patience", "That is what makes this so powerful", "The message was clear:", "This shows the importance of"); a narrator who states the feeling the action just showed
**Problem:** The point arrives twice, once as evidence and once as a summary, because the writer does not trust the example to land. Cut the summary and let the example carry it. Keep a sentence that adds a fact or consequence the example does not show.
**Before:**
> The build took 40 minutes in January and takes 6 minutes now. This shows the importance of investing in developer tooling.
**After:**
> The build took 40 minutes in January and takes 6 minutes now.

### 4. Sayings that sound deep
...
### 5. Staged run-up before the point
...
### 19. Stock body sensations for emotion

**Watch for:** heart pounded, raced, or sank; stomach dropped, knotted, or churned; breath caught; throat tightened; chest tightened; a chill ran down her spine; knuckles whitened; shoulders sagged
**Problem:** Feeling is reported through a small set of standard body sensations instead of through what the person does or notices. Models reach for these far more often than writers do. Name the feeling plainly, or give the action or detail that carries it. Keep a physical reaction the scene needs, and keep real medical or physical description. *Weak alone.*
**Before:**
> Her stomach dropped as she read the message. Her heart pounded and her throat tightened.
**After:**
> She read the message twice, then set the phone face down on the table.
...
### 25. Knowledge-limit disclaimers and guesses
...
### 26. A heading repeated in the first sentence
...
### 27. Writing about the previous version
...
The patterns come from Wikipedia's ["Signs of AI writing"](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup, and from reviews of AI-generated text on Wikipedia and elsewhere. §3 and §19 also draw on ["StoryScope"](https://arxiv.org/abs/2604.03136), a 2026 study from the University of Maryland and Google DeepMind that scored 61,608 stories on structure alone.
