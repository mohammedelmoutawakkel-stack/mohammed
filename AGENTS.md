...
- `SKILL.md` is the source of truth and the repo's only skill file. It contains portable YAML metadata, 37 numbered patterns, and their examples.
...
- **Patterns:** The skill has 37 numbered patterns. If you add, remove, or renumber a pattern, update the README table, heading, validator, and every pattern reference.
