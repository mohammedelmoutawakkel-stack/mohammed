...
Humanizer keeps marketing copy useful instead of flattening it into neutral reference prose. It keeps the primary keyword in meaningful placements, heading hierarchy, links and their targets, images and alt text, metadata and frontmatter, answer-first content, how-to and FAQ structure, calls to action, and benefits that the source supports. It removes vague hype but does not remove honest persuasion, scannable structure, or brand choices just because they are common AI tells. It never adds statistics, testimonials, customers, logos, counts, rankings, capabilities, or outcomes.
...
- **2.11.3** - Added marketing-copy guardrails. Humanizer now keeps supported claims, SEO structure, and useful calls to action while removing vague hype. It must not invent marketing proof or product details. No change to the 35 patterns.
