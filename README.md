...
- **2.11.3** - Fixed the §7, §8, and §12 examples so their rewrites no longer add details missing from their sources (completes the example audit from #187). No change to the 35 patterns.
