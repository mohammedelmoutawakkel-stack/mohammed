...
- **2.10.1** - Added "load-bearing" (figurative use, as in "load-bearing principles/decisions") to the Overused AI Vocabulary watchlist (pattern #7). No change to the 33 patterns.
